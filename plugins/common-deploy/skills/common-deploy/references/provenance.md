...
source-of-truth:
  ...
  note: "official pack `common-deploy-skills` (3 skills)"
source-of-text:
  origin: agent-skills
...
# Provenance — common-deploy

This Atlas curation wrapper curates the official **`common-deploy-skills`** pack (3 skills).
