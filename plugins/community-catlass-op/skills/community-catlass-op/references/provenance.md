...
source-of-truth:
  ...
  path: community/Op
  note: "official pack `community-catlass-op-skills` (4 skills)"
source-of-text:
  origin: agent-skills
...
# Provenance — community-catlass-op

This Atlas curation wrapper curates the official **`community-catlass-op-skills`** pack (4 skills).
