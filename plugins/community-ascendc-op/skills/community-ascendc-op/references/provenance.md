...
source-of-truth:
  ...
  path: community/Op
  note: "official pack `community-ascendc-op-skills` (17 skills)"
source-of-text:
  origin: agent-skills
  ref: agent-skills@d4504945:community/Op
  note: "Apache-2.0 (code) + CC-BY-SA-4.0 (docs) — quote with attribution; prefer routing to Atlas tools"
license: Apache-2.0+CC-BY-SA-4.0
---

# Provenance — community-ascendc-op

This Atlas curation wrapper curates the official **`community-ascendc-op-skills`** pack (17 skills).

- **Source of truth:** `agent-skills` @ `d4504945` (gitcode.com/Ascend/agent-skills), path `community/Op`.
