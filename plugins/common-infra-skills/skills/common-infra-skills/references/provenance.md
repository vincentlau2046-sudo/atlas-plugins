...
source-of-truth:
  ...
  note: "official pack `common-infra-skills` (6 skills)"
source-of-text:
  origin: agent-skills
...
# Provenance — common-infra-skills

This Atlas curation wrapper curates the official **`common-infra-skills`** pack (6 skills).
